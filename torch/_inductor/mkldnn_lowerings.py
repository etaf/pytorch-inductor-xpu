...
def register_onednn_fusion_ops():
    if torch._C._has_mkldnn:
        ...
        aten_mkldnn_linear_binary_ = ExternKernelChoice(
        ...
        cpu_needs_realized_inputs = [
            ...
            torch.ops.mkldnn._linear_pointwise,
            torch.ops.mkldnn._linear_pointwise_,
        ...
        # ):
        #     return TensorBox.create(
        #         mkldnn_ir.LinearBinaryInplace.create(
        #             x, y, w, b, attr,
        #         )
        #     )
        ...
        def linear_binary_inplace(
            ...
            if len(choices) == 0 or use_aten_gemm_kernels():
                ...
                if b is None:
                    kwargs["B"] = None
                choices.append(
                    aten_mkldnn_linear_binary_.bind(
                        [x, y, w] if b is None else [x, y, w, b],
                        layout,
                        **kwargs,
                    )
