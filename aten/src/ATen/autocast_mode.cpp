...
TORCH_LIBRARY_IMPL(aten, AutocastXPU, m) {
  // lower_precision_fp cast policy
  KERNEL_XPU(conv1d, lower_precision_fp)
  KERNEL_XPU2(conv1d, padding, lower_precision_fp)
  KERNEL_XPU(conv2d, lower_precision_fp)
  KERNEL_XPU2(conv2d, padding, lower_precision_fp)
  KERNEL_XPU(conv3d, lower_precision_fp)
  KERNEL_XPU2(conv3d, padding, lower_precision_fp)
  KERNEL_XPU(bmm, lower_precision_fp)
  KERNEL_XPU(mm, lower_precision_fp)
  KERNEL_XPU(linalg_vecdot, lower_precision_fp)
  KERNEL_XPU(baddbmm, lower_precision_fp)
  KERNEL_XPU(addmm, lower_precision_fp)
  KERNEL_XPU(addbmm, lower_precision_fp)
  KERNEL_XPU(linear, lower_precision_fp)
  KERNEL_XPU2(_convolution, deprecated, lower_precision_fp)
  KERNEL_XPU(matmul, lower_precision_fp)
  KERNEL_XPU(conv_tbc, lower_precision_fp)
  KERNEL_XPU(mkldnn_rnn_layer, lower_precision_fp)
  KERNEL_XPU(conv_transpose1d, lower_precision_fp)
  KERNEL_XPU2(conv_transpose2d, input, lower_precision_fp)
  KERNEL_XPU2(conv_transpose3d, input, lower_precision_fp)
  KERNEL_XPU(prelu, lower_precision_fp)
  KERNEL_XPU(scaled_dot_product_attention, lower_precision_fp)
  KERNEL_XPU(_native_multi_head_attention, lower_precision_fp)

  // fp32 cast policy
  KERNEL_XPU(avg_pool3d, fp32)
  KERNEL_XPU(binary_cross_entropy, fp32)
  KERNEL_XPU(grid_sampler, fp32)
  KERNEL_XPU(polar, fp32)
  KERNEL_XPU(prod, fp32)
  KERNEL_XPU2(prod, dim_int, fp32)
  KERNEL_XPU2(prod, dim_Dimname, fp32)
  KERNEL_XPU(quantile, fp32)
  KERNEL_XPU2(quantile, scalar, fp32)
  KERNEL_XPU(nanquantile, fp32)
  KERNEL_XPU2(nanquantile, scalar, fp32)
  KERNEL_XPU(stft, fp32)
  KERNEL_XPU2(stft, center, fp32)
  KERNEL_XPU(cdist, fp32)
  KERNEL_XPU(grid_sampler_2d, fp32)
  KERNEL_XPU(_grid_sampler_2d_cpu_fallback, fp32)
  KERNEL_XPU(grid_sampler_3d, fp32)
  KERNEL_XPU(trace, fp32)
  KERNEL_XPU(view_as_complex, fp32)
  KERNEL_XPU(cholesky, fp32)
  KERNEL_XPU(cholesky_inverse, fp32)
  KERNEL_XPU(cholesky_solve, fp32)
  KERNEL_XPU(inverse, fp32)
  KERNEL_XPU(lu_solve, fp32)
  KERNEL_XPU(orgqr, fp32)
  KERNEL_XPU(ormqr, fp32)
  KERNEL_XPU(pinverse, fp32)
  KERNEL_XPU(max_pool3d, fp32)
  KERNEL_XPU(max_unpool2d, fp32)
  KERNEL_XPU(max_unpool3d, fp32)
  KERNEL_XPU(adaptive_avg_pool3d, fp32)
  KERNEL_XPU(reflection_pad1d, fp32)
  KERNEL_XPU(reflection_pad2d, fp32)
  KERNEL_XPU(replication_pad1d, fp32)
  KERNEL_XPU(replication_pad2d, fp32)
  KERNEL_XPU(replication_pad3d, fp32)
  KERNEL_XPU(mse_loss, fp32)
  KERNEL_XPU(cosine_embedding_loss, fp32)
  KERNEL_XPU(nll_loss, fp32)
  KERNEL_XPU(nll_loss2d, fp32)
  KERNEL_XPU(hinge_embedding_loss, fp32)
  KERNEL_XPU(poisson_nll_loss, fp32)
  KERNEL_XPU(smooth_l1_loss, fp32)
  KERNEL_XPU(cross_entropy_loss, fp32)
  KERNEL_XPU(l1_loss, fp32)
  KERNEL_XPU(huber_loss, fp32)
  KERNEL_XPU(margin_ranking_loss, fp32)
  KERNEL_XPU(soft_margin_loss, fp32)
  KERNEL_XPU(triplet_margin_loss, fp32)
  KERNEL_XPU(multi_margin_loss, fp32)
  KERNEL_XPU2(ctc_loss, IntList, fp32)
  KERNEL_XPU2(ctc_loss, Tensor, fp32)
  KERNEL_XPU(kl_div, fp32)
  KERNEL_XPU(multilabel_margin_loss, fp32)
  KERNEL_XPU(binary_cross_entropy_with_logits, fp32)
  KERNEL_XPU(fft_fft, fp32)
  ...
  KERNEL_XPU(linalg_cond, fp32)
  KERNEL_XPU2(linalg_cond, p_str, fp32)
  KERNEL_XPU(linalg_matrix_rank, fp32)
  KERNEL_XPU2(linalg_matrix_rank, tol_tensor, fp32)
  KERNEL_XPU2(linalg_matrix_rank, atol_rtol_tensor, fp32)
  KERNEL_XPU2(linalg_matrix_rank, atol_rtol_float, fp32)
  KERNEL_XPU(linalg_solve, fp32)
  KERNEL_XPU(linalg_cholesky, fp32)
  KERNEL_XPU(linalg_svdvals, fp32)
  KERNEL_XPU(linalg_eigvals, fp32)
  KERNEL_XPU(linalg_eigvalsh, fp32)
  KERNEL_XPU(linalg_inv, fp32)
  KERNEL_XPU(linalg_householder_product, fp32)
  KERNEL_XPU(linalg_tensorinv, fp32)
  KERNEL_XPU(linalg_tensorsolve, fp32)
  KERNEL_XPU(fake_quantize_per_tensor_affine, fp32)
  KERNEL_XPU(geqrf, fp32)
  KERNEL_XPU(_lu_with_info, fp32)
  KERNEL_XPU(qr, fp32)
  KERNEL_XPU(svd, fp32)
  KERNEL_XPU(triangular_solve, fp32)
  KERNEL_XPU(fractional_max_pool2d, fp32)
  KERNEL_XPU(fractional_max_pool3d, fp32)
  KERNEL_XPU(adaptive_max_pool3d, fp32)
  KERNEL_XPU(multilabel_margin_loss_forward, fp32)
  KERNEL_XPU(linalg_qr, fp32)
  KERNEL_XPU(linalg_cholesky_ex, fp32)
  KERNEL_XPU(linalg_svd, fp32)
  KERNEL_XPU(linalg_eig, fp32)
  KERNEL_XPU(linalg_eigh, fp32)
  KERNEL_XPU(linalg_lstsq, fp32)
  KERNEL_XPU(linalg_inv_ex, fp32)

  // promote
  KERNEL_XPU(stack, promote)
  KERNEL_XPU(cat, promote)
  KERNEL_XPU(index_copy, promote)
  KERNEL_XPU2(index_copy, dimname, promote)
}
